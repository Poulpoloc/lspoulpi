...
async function createServer(
    ...
    const clientOptions: LanguageClientOptions = {
        ...
        documentSelector: isVirtualWorkspace()
            ? [{ language: 'tantacule' }]
            : [
                  { scheme: 'file', language: 'tantacule' },
                  { scheme: 'untitled', language: 'tantacule' },
                  { scheme: 'vscode-notebook', language: 'tantacule' },
                  { scheme: 'vscode-notebook-cell', language: 'tantacule' },
              ],
